...
# Run `pod lib lint awareframework_pedometer.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'awareframework_pedometer'
  s.version          = '0.0.1'
...
A new flutter plugin project.
  ...
  s.dependency 'com.awareframework.ios.sensor.pedometer'
